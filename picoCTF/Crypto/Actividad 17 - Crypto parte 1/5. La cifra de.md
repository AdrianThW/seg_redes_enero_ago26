...
Usando la siguiente pagina se puede resolver este reto https://www.guballa.de/vigenere-solver

El mensaje encriptado es el siguiente:

```
adrian@ThW:~/Documents/adicional_seg$ nc fickle-tempest.picoctf.net 63247
Encrypted message:
