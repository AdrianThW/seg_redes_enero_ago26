...
Can you figure out how this program works to get the flag? Connect to the program with netcat: `$ nc saturn.picoctf.net 64775` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/526/picker-III.py).

```
adrian@ThW:~/Documents/adicional_seg/reverse2/timer$ nc saturn.picoctf.net 64775
==> ?
...
<function win at 0x782016bf0dc0>
==> 4
