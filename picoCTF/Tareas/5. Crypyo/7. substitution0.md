...
Dsu mxow vj: pvncNDM{5YH5717Y710G_3I0XY710G_03055505}adrian@ThW:~/Documents/adicional_seg/crpyto/crypto$ 

```

Como el hint lo dice, hay que subtituir el primera linea que es el "plaintext" y covertirlo al abecediario convencional, y asi nos da el texto entendible. Cyberchef nos puede ayudar.
